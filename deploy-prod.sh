...
SOURCE="./"
REMOTE_PATH="~/projects/llm-rag"
ABSOLUTE_REMOTE_PATH="/home/ubuntu/projects/llm-rag"
...
START_COMMAND="$ABSOLUTE_REMOTE_PATH/venv/bin/streamlit run Scripts/UI/app.py"
...
[Unit]
Description=LLM RAG Application
